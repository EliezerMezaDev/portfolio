...
home:
  ...
  howTitle: "How I work"
  how1: >-
    **1. Context before code**. Before writing a single line of code, I analyze the
    project’s context: the constraints, business rules, and
    implicit limitations *(APIs that cannot be modified, specific
    working conditions, compliance requirements)*. The problem defines the
    solution, not the other way around.
  how2: >-
    **2. Consistent stack decisions**. With the context in hand, I select
    the tools best suited to the task—not just frameworks, but
    also platforms, libraries, and services. My experience with multiple
    stacks allows me to choose based on what the problem requires.
  how3: >-
    **3. Pragmatic Development**. I make architectural and
    development decisions that streamline the process without compromising quality, optimizing efficiency in both time and execution, without cutting corners.
  how4: >-
    **4. Measurable Results**. Every project I’m involved in has 
    quantifiable metrics that demonstrate the improvement achieved and the effectiveness
    of what has been developed. If success isn’t defined before we start, we’re
    working toward the wrong goal.
  how5: >-
    **5. Process Review**. When I wrap up a project, I analyze the entire journey:
    what worked, what didn't, and where I can grow as a
    software engineer.
  stackTitle: "Stack"
  stackDesc: >-
    My core stack is Python/FastAPI, Next.js, Flutter, and Node.js, with
...
metrics:
  - "5+ yrs full-stack"
  - "+300 crypto tx/mo in production wallets"
  - "−30% load time on fintech UI"
...
cv:
  ...
  education:
    ...
    thesis: "Outstanding-mention thesis: internal process-management system for a technical-service department."
    certs: "Certifications (Udemy)"
    certList:
